...
fdescribe('user api', () => {
  ...
  describe('create', () => {
    ...
    it('should fail on undefined username', () => {
      ...
      expect(() => userApi.create(username, password, { name, surname })).toThrowError(
        RequirementError,
  ...
  describe('authenticate', () => {
    ...
    beforeEach(() =>
      userApi
        .create(username, password, { name, surname })
    ...
    it('should fail on non-existing user', () =>
      userApi.authenticate((username = 'unexisting-user@mail.com'), password).then(response => {
        expect(response).toBeDefined();
